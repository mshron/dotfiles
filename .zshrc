...
# Disable auto-setting terminal title (we use the title() function instead)
...
plugins=(git colored-man-pages history zsh-autosuggestions fast-syntax-highlighting)
